...
param FunctionAppZipUrl string = 'https://github.com/mlunetta/AVDSessionHostReplacer/releases/download/latest/FunctionApp.zip'
...
var varFunctionAppName = 'func-avdshr-${varUniqueString}'
